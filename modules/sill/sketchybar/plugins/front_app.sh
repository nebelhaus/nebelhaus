...
# navigate_mode.sh), keep that mode's glyph appended — focusing another window
# repaints this label, which would otherwise drop it. Keep glyphs in sync with
# those plugins: fa-arrows-h (U+F07E) for resize, fa-arrows (U+F047) for navigate.
